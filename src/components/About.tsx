        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-4 bg-white dark:bg-gray-900 rounded-xl shadow-inner flex items-center justify-center">
                <div className="text-center">
                  <div className="w-40 h-40 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                    <img
                      src="/Paras-bhatia.png"
                      alt="Paras Bhatia"
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              innovative web solutions. My journey in software development has
              equipped me with strong technical skills and a problem-solving
              mindset.
            </p>

            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              I specialize in building responsive, user-friendly applications
              using modern technologies like React, Node.js, Express, and
              MongoDB. I believe in writing clean, maintainable code and staying
